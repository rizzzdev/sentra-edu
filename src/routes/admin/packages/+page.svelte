...
import { packageStore } from '$lib/api';
  ...
  async function handleConfirmDelete() {
    ...
    const response = await api.packages.delete(deletingPackageId);
...
<div class="alert alert-info">
  ...
  <span>
    <strong>Biaya Orang Tua</strong> = harga paket (SPP). <strong>Honor Tentor per Sesi</strong> = yang diterima tentor per sesi (sudah termasuk transport).
  </span>
</div>
      ...
      <table class="tbl">
        <thead>
          <tr>
            ...
            <th class="num">Harga (Orang Tua)</th>
