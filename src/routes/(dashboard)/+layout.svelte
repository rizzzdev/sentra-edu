<script lang="ts">
  ...
  const pageTitleMap: Record<string, string> = {
    ...
    '/admin/students/wali': 'Data Master Wali Murid',
    '/admin/magic-links': 'Magic Link Pendaftaran Siswa',
    '/admin/tentors': 'Data Master Tentor / Mentor',
    '/admin/tentors/magic-links': 'Magic Link Pendaftaran Tentor',
    '/admin/attendance': 'Presensi & Laporan Materi',
    '/admin/payroll': 'Klaim & Pembayaran Honor Tentor',
    ...
    '/admin/analitik': 'Analitik Operasional & Finansial',
    '/admin/laporan': 'Laporan & Ekspor Data',
    '/admin/profile': 'Profil Akun Pengguna',
    '/tentor': 'Dashboard Ikhtisar',
    '/tentor/dashboard': 'Dashboard Ikhtisar',
    '/tentor/jobboard': 'Bursa Lowongan Mengajar',
    '/tentor/attendance': 'Presensi Saya',
    '/tentor/payroll': 'Klaim & Pembayaran Honor',
    '/tentor/profile': 'Profil Akun Pengguna',
    ...
    '/wali': 'Dashboard Ikhtisar',
    '/wali/dashboard': 'Dashboard Ikhtisar',
    '/wali/children': 'Program Les Anak',
    '/wali/attendance': 'Presensi Anak',
    '/wali/reports': 'Laporan Hasil Belajar',
    '/wali/invoices': 'Tagihan SPP & Pembayaran',
    '/wali/profile': 'Profil Akun Pengguna',
    '/jobs': 'Lowongan Les Privat',
    '/students': 'Data Master Murid',
    '/students/wali': 'Data Master Wali Murid',
    '/magic-links': 'Magic Link Pendaftaran Siswa',
    '/tentors': 'Data Master Tentor / Mentor',
    '/tentors/magic-links': 'Magic Link Pendaftaran Tentor',
