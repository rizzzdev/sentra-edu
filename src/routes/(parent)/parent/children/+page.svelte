...
<div class="page-head">
  <div>
    ...
    <div class="desc">Daftar program bimbingan belajar anak Anda yang sedang berjalan.</div>
  </div>
</div>
...
<div class="filter-bar mb-6">
  <div class="search-box">
    ...
    <input
      type="text"
      placeholder="Cari nama anak, mapel, kelas, atau tentor..."
...
{:else if filteredPrograms.length === 0}
  <div class="empty-state">
    ...
    <p>
      ...
      {:else}
        Belum ada program bimbingan belajar aktif untuk anak Anda.
      {/if}
    </p>
    {#if searchQuery || modeFilter !== 'ALL'}
      <button
      ...
      <div class="program-card">
        ...
        <div class="p-details">
          ...
          <div class="detail-row">
            ...
            <div class="d-content">
              <div class="d-label">Murid / Anak</div>
              <div class="d-value font-medium group-students">
