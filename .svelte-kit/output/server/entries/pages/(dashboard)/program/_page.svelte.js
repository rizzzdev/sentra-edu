...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    myEnrollments = currentUser ? store_get($$store_subs ??= {}, "$dbStore", dbStore).enrollments.filter((e) => e.deletedAt === null && e.studentId === currentUser?.id) : [];
    $$renderer2.push(`<div class="page-head"><div><h3>`);
    Icon($$renderer2, { name: "school", size: "lg" });
    $$renderer2.push(`<!----> Program Les Aktif</h3> <div class="desc">Program bimbingan belajar yang sedang berjalan.</div></div></div> `);
    if (myEnrollments.length === 0) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="empty-state">`);
      Icon($$renderer2, { name: "school", size: "xl" });
      $$renderer2.push(`<!----> <p>Belum ada program les terdaftar.</p></div>`);
    } else {
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<!--[-->`);
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        $$renderer2.push(`<div class="job-card"><div class="j-top"><div class="j-title">${escape_html(getClassName(e.classId))} · ${escape_html(getSubjectName(e.subjectId))}</div> <span class="badge b-assigned">`);
        ...
        Icon($$renderer2, { name: "family_restroom", size: "xs" });
        $$renderer2.push(`<!----> Wali: ${escape_html(wali ? wali.fullName : "—")} (${escape_html(wali ? wali.phone || "—" : "—")})</span> <span>`);
